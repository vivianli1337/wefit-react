...
export default function PostForm({ addPost, isAuthenticated }: PostFormProps) {
  const [title, setTitle] = useState("");
  const [message, setMessage] = useState("");

  if (!isAuthenticated) {
    return <p className="text-center">Please log in to create a post.</p>;
  }
  ...
  return (
    <div className="container mb-4">
      <h1 className="fw-bold mb-4">Community Forum</h1>
      <div className="form-group mb-3">
        <label htmlFor="title">Title</label>
        <input
          type="text"
